...
Usage:
    uv run python scripts/reconcile_taxpnl.py \
        [--tradebook data/tradebook-ZZZ999-EQ.csv] \
        [--taxpnl data/taxpnl-ZZZ999-2026_2027-Q1-Q1.xlsx] \
...
_DEF_TRADEBOOK = "data/tradebook-ZZZ999-EQ.csv"
_DEF_TAXPNL = "data/taxpnl-ZZZ999-2026_2027-Q1-Q1.xlsx"
