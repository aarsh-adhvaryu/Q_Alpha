...
_As of **2026-07-14** · 3 marks · market weakness: **elevated** · AI: lean=down confidence=medium (tilt 0.75×) · **fake money, no real orders**._

| Book | What it is | Value | Contributed | Profit | Return |
|---|---|---:|---:|---:|---:|
| **system** | 🧠 **System** — deploys on its own advice (AI-paced) + tax-gated rebalance | ₹347,101 | ₹350,000 | ₹-2,899 | -0.83% |
| **shadow** | System, AI off (the attribution twin) | ₹346,712 | ₹350,000 | ₹-3,288 | -0.94% |
| **baseline** | Everything into NIFTYBEES (do-nothing baseline) | ₹347,812 | ₹350,000 | ₹-2,188 | -0.63% |

- **System − Baseline** (does the whole system beat doing nothing?): **₹-711**
- **System − Shadow** (does the AI add value?): **₹389**
- **AI deploy hit-rate** (system deploys that beat Nifty over ~20d): **0/0**

## Today's decisions

- **system** deployed ₹10,547 — weakness=elevated; deploy ₹10,547 into: VEDL.NS (−66%), IRFC.NS (−34%), INFY.NS (−34%)
- **shadow** deployed ₹18,750 — weakness=elevated; deploy ₹18,750 into: VEDL.NS (−66%), TRENT.NS (−48%), IRFC.NS (−34%)
- gate: hold: §4.6 net-benefit gate not cleared (risk cut < 2× cost+tax)

## 🛡 Downside protection — the tax-free hedge overlay

- **System book:** return **-0.61%** hedged vs **-0.61%** unhedged · worst drawdown **−0.6%** vs **−0.6%** · episodes **0** · now: hedge off (calm)
- **Validated ₹2L core (measured only — the GO book itself is untouched):** return **+1.40%** hedged vs **+1.40%** unhedged · worst drawdown **−2.4%** vs **−2.4%**
