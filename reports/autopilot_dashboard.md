...
_As of **2026-07-31** · 16 marks · market weakness: **elevated** · AI: lean=up confidence=medium (tilt 1.25×) · **fake money, no real orders**._

| Book | What it is | Value | Contributed | Profit | Return |
|---|---|---:|---:|---:|---:|
| **system** | 🧠 **System** — deploys on its own advice (AI-paced) + tax-gated rebalance | ₹356,774 | ₹350,000 | ₹6,774 | +1.94% |
| **shadow** | System, AI off (the attribution twin) | ₹356,089 | ₹350,000 | ₹6,089 | +1.74% |
| **baseline** | Everything into NIFTYBEES (do-nothing baseline) | ₹352,989 | ₹350,000 | ₹2,989 | +0.85% |

- **System − Baseline** (does the whole system beat doing nothing?): **₹3,785**
- **System − Shadow** (does the AI add value?): **₹685**
...
- **System book:** return **+2.20%** hedged vs **+2.20%** unhedged · worst drawdown **−1.4%** vs **−1.4%** · episodes **0** · now: hedge off (calm)
- **Validated ₹2L core (measured only — the GO book itself is untouched):** return **+1.64%** hedged vs **+1.64%** unhedged · worst drawdown **−2.4%** vs **−2.4%**
