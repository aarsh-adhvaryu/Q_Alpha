...
_As of **2026-07-30** · 15 marks · market weakness: **elevated** · AI: lean=flat confidence=medium (tilt 1.00×) · **fake money, no real orders**._

| Book | What it is | Value | Contributed | Profit | Return |
|---|---|---:|---:|---:|---:|
| **system** | 🧠 **System** — deploys on its own advice (AI-paced) + tax-gated rebalance | ₹357,497 | ₹350,000 | ₹7,497 | +2.14% |
| **shadow** | System, AI off (the attribution twin) | ₹355,537 | ₹350,000 | ₹5,537 | +1.58% |
| **baseline** | Everything into NIFTYBEES (do-nothing baseline) | ₹351,806 | ₹350,000 | ₹1,806 | +0.52% |

- **System − Baseline** (does the whole system beat doing nothing?): **₹5,691**
- **System − Shadow** (does the AI add value?): **₹1,960**
...
- **System book:** return **+2.41%** hedged vs **+2.41%** unhedged · worst drawdown **−1.4%** vs **−1.4%** · episodes **0** · now: hedge off (calm)
- **Validated ₹2L core (measured only — the GO book itself is untouched):** return **+1.53%** hedged vs **+1.53%** unhedged · worst drawdown **−2.4%** vs **−2.4%**
