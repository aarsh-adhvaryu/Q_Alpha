...
_As of **2026-08-06** · 20 marks · market weakness: **elevated** · AI: lean=up confidence=medium (tilt 1.25×) · **fake money, no real orders**._

| Book | What it is | Value | Contributed | Profit | Return |
|---|---|---:|---:|---:|---:|
| **system** | 🧠 **System** — deploys on its own advice (AI-paced) + tax-gated rebalance | ₹412,540 | ₹400,000 | ₹12,540 | +3.13% |
| **shadow** | System, AI off (the attribution twin) | ₹411,157 | ₹400,000 | ₹11,157 | +2.79% |
| **baseline** | Everything into NIFTYBEES (do-nothing baseline) | ₹407,150 | ₹400,000 | ₹7,150 | +1.79% |

- **System − Baseline** (does the whole system beat doing nothing?): **₹5,389**
- **System − Shadow** (does the AI add value?): **₹1,382**
- **AI deploy hit-rate** (system deploys that beat Nifty over ~20d): **0/0**

## Today's decisions

- **system** deployed ₹6,246 — weakness=elevated; deploy ₹6,246 into: VEDL.NS (−65%), IRFC.NS (−32%), HDFCLIFE.NS (−32%)
...
- **System book:** return **+3.85%** hedged vs **+3.85%** unhedged · worst drawdown **−1.4%** vs **−1.4%** · episodes **0** · now: hedge off (calm)
- **Validated ₹2L core (measured only — the GO book itself is untouched):** return **+1.73%** hedged vs **+1.73%** unhedged · worst drawdown **−2.4%** vs **−2.4%**
