...
_Notional paper trading (no real money) of the validated tax-aware strategy. As of **2026-07-06** · generated 2026-07-06 15:57 UTC._

## At a glance

| | |
|---|---|
| Started | 2026-06-12 (24 days) |
| Notional capital | ₹200,000 |
| Equity (marked) | ₹205,500 |
| Return since start | **+2.75%** |
...
|---|---|---|---|---|
| APOLLOHOSP.NS | 4 | ₹8888.50 | ₹35,554 | 17.3% |
| ASIANPAINT.NS | 14 | ₹2754.90 | ₹38,569 | 18.8% |
| BEL.NS | 98 | ₹425.55 | ₹41,704 | 20.3% |
| NTPC.NS | 113 | ₹356.25 | ₹40,256 | 19.6% |
| SUNPHARMA.NS | 22 | ₹1912.80 | ₹42,082 | 20.5% |

## Equity track record

`▁▁▁▃▄▅▅▄▃▁▃▂▄▅▆█`  (16 daily marks; full series in `paper_equity.csv`)
...
- 🟡 **Track length** — 16/63 trading days — building the minimum sample for a meaningful estimate.
...
- 🟡 **Forward vs benchmark** — within noise of the benchmark (≤ 3% behind) — strategy +3.1% vs Nifty +3.6% (Δ -0.5%).
...
**🟢 healthy** — last autonomous run **2026-07-06T15:57:40Z** (market date 2026-07-06, `daily`).

- Action: held — no action
- Decision: holding — next scheduled rebalance on/after 2027-01-01
- Equity: ₹205,500 (+2.75%) · GO: **NOT YET**
- Freshness: ✓ Up to date — last marked 2026-07-06.

_Recent runs (last 10 of 12):_
