...
_Notional paper trading (no real money) of the validated tax-aware strategy. As of **2026-07-09** · generated 2026-07-09 15:39 UTC._

## At a glance

| | |
|---|---|
| Started | 2026-06-12 (27 days) |
| Notional capital | ₹200,000 |
| Equity (marked) | ₹201,448 |
| Return since start | **+0.72%** |
| Nifty 50 TRI (same window) | +1.83% |
| Cash | ₹7,335 |
...
|---|---|---|---|---|
| APOLLOHOSP.NS | 4 | ₹8845.50 | ₹35,382 | 17.6% |
| ASIANPAINT.NS | 14 | ₹2673.80 | ₹37,433 | 18.6% |
| BEL.NS | 98 | ₹406.20 | ₹39,808 | 19.8% |
| NTPC.NS | 113 | ₹343.70 | ₹38,838 | 19.3% |
| SUNPHARMA.NS | 22 | ₹1938.70 | ₹42,651 | 21.2% |

## Equity track record

`▁▁▁▃▄▅▅▄▃▁▃▂▄▅▆█▆▂▃`  (19 daily marks; full series in `paper_equity.csv`)
...
- 🟡 **Track length** — 19/63 trading days — building the minimum sample for a meaningful estimate.
...
- 🟡 **Forward vs benchmark** — within noise of the benchmark (≤ 3% behind) — strategy +1.0% vs Nifty +1.8% (Δ -0.8%).
...
**🟢 healthy** — last autonomous run **2026-07-09T15:39:07Z** (market date 2026-07-09, `daily`).

- Action: held — no action
- Decision: holding — next scheduled rebalance on/after 2027-01-01
- Equity: ₹201,448 (+0.72%) · GO: **NOT YET**
- Freshness: ✓ Up to date — last marked 2026-07-09.

_Recent runs (last 10 of 15):_
