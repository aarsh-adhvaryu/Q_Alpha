...
_Notional paper trading (no real money) of the validated tax-aware strategy. As of **2026-07-01** · generated 2026-07-01 15:16 UTC._

## At a glance

| | |
|---|---|
| Started | 2026-06-12 (19 days) |
| Notional capital | ₹200,000 |
| Equity (marked) | ₹202,131 |
| Return since start | **+1.07%** |
| Nifty 50 TRI (same window) | +1.87% |
| Cash | ₹7,335 |
...
|---|---|---|---|---|
| APOLLOHOSP.NS | 4 | ₹8618.50 | ₹34,474 | 17.1% |
| ASIANPAINT.NS | 14 | ₹2716.40 | ₹38,030 | 18.8% |
| BEL.NS | 98 | ₹416.25 | ₹40,792 | 20.2% |
| NTPC.NS | 113 | ₹357.90 | ₹40,443 | 20.0% |
| SUNPHARMA.NS | 22 | ₹1866.20 | ₹41,056 | 20.3% |

## Equity track record

`▁▁▁▄▆▇█▅▄▁▄▃▆`  (13 daily marks; full series in `paper_equity.csv`)
...
- 🟡 **Track length** — 13/63 trading days — building the minimum sample for a meaningful estimate.
...
- 🟡 **Forward vs benchmark** — within noise of the benchmark (≤ 3% behind) — strategy +1.4% vs Nifty +1.9% (Δ -0.5%).
...
**🟢 healthy** — last autonomous run **2026-07-01T15:16:57Z** (market date 2026-07-01, `daily`).

- Action: held — no action
- Decision: holding — next scheduled rebalance on/after 2027-01-01
- Equity: ₹202,131 (+1.07%) · GO: **NOT YET**
- Freshness: ✓ Up to date — last marked 2026-07-01.

_Recent runs (last 9 of 9):_
