...
_Notional paper trading (no real money) of the validated tax-aware strategy. As of **2026-08-28** · generated 2026-08-31 19:09 UTC._

## At a glance

| | |
|---|---|
| Started | 2026-06-12 (77 days) |
| Notional capital | ₹200,000 |
| Equity (marked) | ₹121,519 |
| Return since start | **-39.24%** |
| Nifty 50 TRI (same window) | +2.94% |
| Cash | ₹7,335 |
...
|---|---|---|---|---|---|
| APOLLOHOSP.NS | 4 | ₹0 | ₹0 | 0.0% | ⏳ 289d · 13 Jun 27 |
| ASIANPAINT.NS | 14 | ₹2608.70 | ₹36,522 | 30.1% | ⏳ 289d · 13 Jun 27 |
| BEL.NS | 98 | ₹411.90 | ₹40,366 | 33.2% | ⏳ 289d · 13 Jun 27 |
| NTPC.NS | 113 | ₹330.05 | ₹37,296 | 30.7% | ⏳ 289d · 13 Jun 27 |
| SUNPHARMA.NS | 22 | ₹0 | ₹0 | 0.0% | ⏳ 289d · 13 Jun 27 |
...
`▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇█▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▁`  (55 daily marks; full series in `paper_equity.csv`)
...
- 🟡 **Track length** — 55/63 trading days — building the minimum sample for a meaningful estimate.
...
- 🟡 **Forward vs benchmark** — trailing, but the 63-day power floor isn't met yet — too short to be a NO-GO (short-sample noise) — strategy -39.1% vs Nifty +2.9% (Δ -42.0%).
- 🔴 **Drawdown behaviour** — fell 38.6% more than the market — idiosyncratic, behaviour diverged from the validated profile. worst live drawdown -40.9% vs Nifty -2.2% (excess -38.6%).
- 🟢 **Data integrity** — dense track record (largest gap 4 days).

## 🩺 System health & run log

**🟢 healthy** — last autonomous run **2026-08-31T19:09:42Z** (market date 2026-08-28, `daily`).

- Action: held — no action
- Decision: holding — next scheduled rebalance on/after 2027-01-01
- Equity: ₹121,519 (-39.24%) · GO: **NO-GO**
- Freshness: ✓ Up to date — last marked 2026-08-28.
