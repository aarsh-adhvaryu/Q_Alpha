...
_Notional paper trading (no real money) of the validated tax-aware strategy. As of **2026-08-04** · generated 2026-08-04 14:46 UTC._

## At a glance

| | |
|---|---|
| Started | 2026-06-12 (53 days) |
| Notional capital | ₹200,000 |
| Equity (marked) | ₹202,793 |
| Return since start | **+1.40%** |
| Nifty 50 TRI (same window) | +4.08% |
| Cash | ₹7,335 |
...
|---|---|---|---|---|---|
| APOLLOHOSP.NS | 4 | ₹9050.00 | ₹36,200 | 17.9% | ⏳ 312d · 12 Jun 27 |
| ASIANPAINT.NS | 14 | ₹2775.00 | ₹38,850 | 19.2% | ⏳ 312d · 12 Jun 27 |
| BEL.NS | 98 | ₹391.50 | ₹38,367 | 18.9% | ⏳ 312d · 12 Jun 27 |
| NTPC.NS | 113 | ₹343.65 | ₹38,832 | 19.1% | ⏳ 312d · 12 Jun 27 |
| SUNPHARMA.NS | 22 | ₹1964.00 | ₹43,208 | 21.3% | ⏳ 312d · 12 Jun 27 |
...
`▁▁▁▃▄▅▅▄▃▁▃▂▄▅▆█▆▂▃▄▄▄▄▄▃▅▅▅▄▃▆▄▄▄▅▅▅`  (37 daily marks; full series in `paper_equity.csv`)
...
- 🟡 **Track length** — 37/63 trading days — building the minimum sample for a meaningful estimate.
...
- 🟡 **Forward vs benchmark** — within noise of the benchmark (≤ 3% behind) — strategy +1.7% vs Nifty +4.1% (Δ -2.4%).
...
**🟢 healthy** — last autonomous run **2026-08-04T14:46:22Z** (market date 2026-08-04, `daily`).

- Action: held — no action
- Decision: holding — next scheduled rebalance on/after 2027-01-01
- Equity: ₹202,793 (+1.40%) · GO: **NOT YET**
- Freshness: ✓ Up to date — last marked 2026-08-04.

_Recent runs (last 10 of 38):_
