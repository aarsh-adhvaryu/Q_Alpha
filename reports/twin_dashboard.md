...
_Generated 2026-09-11 06:45 UTC. Fake money; the real account is the state source and is never traded._
...
| BASELINE_EW | ₹304,144 | ₹293,609 | ₹-10,535 | -56.9%/yr |
| BASELINE | ₹304,144 | ₹294,437 | ₹-9,707 | -53.9%/yr |

**The gate** (GO criterion 3 — the only comparison that authorises anything):
- **CORE_V1** is ahead of **BASELINE_EW** by ₹3,157 (-0.96% relative wealth, G=-0.0097) — **descriptive only**, 0 of 12 months. A window this short is dominated by *when* the money went in, not *what* was picked. No verdict before the locked 12-month evaluation.
- **TWIN_FULL** is behind **BASELINE_EW** by ₹7,734 (-1.92% relative wealth, G=-0.0194) — **descriptive only**, 0 of 12 months. A window this short is dominated by *when* the money went in, not *what* was picked. No verdict before the locked 12-month evaluation.
...
- **TWIN_FULL** is behind **BASELINE** by ₹8,562 (-2.17% relative wealth, G=-0.0219) — **descriptive only**, 0 of 12 months. A window this short is dominated by *when* the money went in, not *what* was picked. No verdict before the locked 12-month evaluation.
...
| 🟡 | Volatility event withstood | worst in-window fall -1.2%, gate needs ≤ -10% |
