...
REM ============================================================================
REM  Q-Alpha - one click, natively on Windows.
REM
...
REM --- 3. Open the browser only once the server actually answers. Opening it
REM ---    first shows a connection error on every cold start, and people learn
REM ---    to reload rather than to read the page.
...
"%UV%" run python scripts/local_run.py --app --no-open --port %PORT%
